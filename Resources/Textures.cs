...
public static class Textures {
    ...
    internal static void Load(Mod mod) {
        ...
        _raceElements[2] = LoadTextures(Patch + "UIs/Race/BgFullIcon_Hover");
        _raceElements[3] = LoadTextures(Patch + "UIs/Race/BgIcon2");
        _raceElements[4] = LoadTextures(Patch + "UIs/Race/BgIcon_Hover2");
        _raceElements[5] = LoadTextures(Patch + "UIs/Race/Stat_Bg");
        _raceElements[6] = LoadTextures(Patch + "UIs/Race/Stat_HP");
        _raceElements[7] = LoadTextures(Patch + "UIs/Race/Stat_HP_Hover");
        _raceElements[8] = LoadTextures(Patch + "UIs/Race/Stat_MP");
        _raceElements[9] = LoadTextures(Patch + "UIs/Race/Stat_MP_Hover");
        _raceElements[10] = LoadTextures(Patch + "UIs/Race/Stat_Info");
        _raceElements[11] = LoadTextures(Patch + "UIs/Race/Test0");
        _raceElements[12] = LoadTextures(Patch + "UIs/Race/Test1");
        _raceElements[13] = LoadTextures(Patch + "UIs/Race/Test2");
        _raceElements[14] = LoadTextures(Patch + "UIs/Race/Test3");
        _raceElements[15] = LoadTextures(Patch + "UIs/Race/Test4");
