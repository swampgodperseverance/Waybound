...
{
    public class ProdigyLava : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int k = 0; k < Projectile.oldPos.Length; k++)
            {
                ...
                Color color = Color.OrangeRed * (0.6f * (1f - progress));
            ...
            Color glowColor = Color.Lerp(Color.OrangeRed, Color.Yellow, 0.5f);
            glowColor.A = 0;
            ...
            Color outlineColor = Color.Lerp(Color.OrangeRed, Color.Red, 0.5f);
            outlineColor.A = 120;
