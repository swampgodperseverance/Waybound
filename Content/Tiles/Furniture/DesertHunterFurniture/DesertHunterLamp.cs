...
{
	public class DesertHunterLamp : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// name.SetDefault("Desert Hunter Lamp");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) => Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 64, ModContent.ItemType<Content.Items.Placeable.Furniture.DesertHunterFurniture.DesertHunterLampI>());
