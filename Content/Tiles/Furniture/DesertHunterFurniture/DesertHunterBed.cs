...
{
	public class DesertHunterBed : ModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			else
			{
				player.noThrow = 2;
				player.cursorItemIconEnabled = true;
				player.cursorItemIconID = ModContent.ItemType<Content.Items.Placeable.Furniture.DesertHunterFurniture.DesertHunterBedI>();
			}
		}
	}
}