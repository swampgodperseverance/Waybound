...
{
	public class DesertHunterChair : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			// name.SetDefault("Desert Hunter Chair");
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.DesertHunterFurniture.DesertHunterChairI>();
