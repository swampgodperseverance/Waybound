...
{
	public class TopazLaserGun : LaserGun
	{
		public override void SetStaticDefaults()
		{
			// Tooltip.SetDefault("");
			// DisplayName.SetDefault("Topaz Laser Gun");
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ProjectileType<TopazLaserGunP>();
            Item.shootSpeed = 1f;
            chargeMax = 205;
            chargeAdd = 1;
            chargeRemove = 4;
	...
	public class TopazLaserGunP : RangedLaser
	{
		public override void SetStaticDefaults()
		{
		...
		public override void SetDefaults()
		{
            ...
            moveSpeed = 2.25f;
            maxDistance = 275;
            laserDust = DustType<TopazLaserGunD>();
    ...
    public class TopazLaserGunD : ModDust
    {
