...
{
	public class DesertHunterBlockI : ModItem
	{
		public override void SetStaticDefaults()
		{
			CreativeItemSacrificesCatalog.Instance.SacrificeCountNeededByItemId[Type] = 99;
			// DisplayName.SetDefault("Desert Hunter Block");
		}
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<DesertHunterBlock>();
			Item.width = 12;
			Item.height = 12;
		...
		public override void AddRecipes()
		{
			CreateRecipe(10)
				...
				.Register();
			CreateRecipe(1)
				.AddIngredient(ModContent.ItemType<DesertHunterBlockWallI>(), 4)
