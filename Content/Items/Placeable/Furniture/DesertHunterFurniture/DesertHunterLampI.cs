...
{
	public class DesertHunterLampI : ModItem
	{
		...
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.DesertHunterFurniture.DesertHunterLamp>());
			Item.width = 32;
			Item.height = 32;
			Item.maxStack = 99;
			Item.rare = 0;
		...
		{
			CreateRecipe()
				.AddRecipeGroup("Waybound:DesertHunterBlockI", 3)
