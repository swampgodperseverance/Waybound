...
{
	public class DesertHunterDresserI : ModItem
	{
		...
		{
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Furniture.DesertHunterFurniture.DesertHunterDresser>());
			Item.width = 32;
			Item.height = 32;
			Item.maxStack = 99;
			Item.rare = 0;
		...
		{
			CreateRecipe()
				.AddRecipeGroup("Waybound:DesertHunterBlockI", 16)
